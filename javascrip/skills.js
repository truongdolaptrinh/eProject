...
//     html += `<li class=${i === 1 ? 'active' : ''}><a>${i}</a></li>`;
//   }
//   document.getElementById('number-page').innerHTML = html;
// }

// function changePage() {
//   document.querySelectorAll('.number-page li').forEach((node, i) => {
//     node.addEventListener('click', () => {
//       idPages = i + 1;
//       document.querySelectorAll('.number-page li').forEach(node => node.classList.remove('active'));
//       node.classList.add('active');
//       btnPrev.classList.toggle('btn-active', idPages === 1);
//       btnNext.classList.toggle('btn-active', idPages === totalPages);
//       getIdPage(idPages);
//       renderProduct();
//     });
//   });
...
// btnNext.addEventListener('click', () => {
//   idPages = Math.min(idPages + 1, totalPages);
//   document.querySelector(`.number-page li:nth-child(${idPages})`).click();
// });

// btnPrev.addEventListener('click', () => {
//   idPages = Math.max(idPages - 1, 1);
//   document.querySelector(`.number-page li:nth-child(${idPages})`).click();
// });
